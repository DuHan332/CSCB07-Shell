 ...
 * file system in specific format.
 * 
 * @author Du Han
 */
public class Tree implements Commands {
  ...
  /**
   * This function would check if the input is valid and initialize the string that should be
   * returned. Then it would call the helper function display tree to traverse the whole file system
