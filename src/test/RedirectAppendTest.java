...
/**
 * This class is used for testing the helper function RedirectAppend. It would test whether the
 * command redirect and append in the correct way or the command throws the correct exception.
...
public class RedirectAppendTest {
  ...
  public void testPathDoesNotExist() {
    ...
    try {
      RedirectAppend.execute("Result from other commands", input, tracker);
   ...
   */
  @Test
  public void testAppendStingToDirectory() {
  ...
  /**
   * It would test if the input is full path and also need to create new file to append.
   */
  @Test
  ...
  /**
   * It would test if the input is full path and append the string to a file that have already
   * existed. existed.
   */
  @Test
  public void testInputIsFullPathAndAppendToExistingFile() {
    ...
    try {
      ...
      assertEquals(cat.execute(inputForConcatenate, tracker), "I am AResult from other commands");
    } catch (SystemErrorException e) {
      fail("No exception should be thrown");
    }
  }
  ...
  /**
   * It would test if the input is relative path and also need to create new file to append.
   */
  @Test
  ...
  /**
   * It would test if the input is relative path and append the string to a file that have already
   * existed.
   */
  @Test
  public void testInputIsRelativePathAndAppendToExistingFile() {
    String input = "FolderA/FileA";
    String[] inputForList = {"/FolderA"};
    String[] inputForConcatenate = {"/FolderA/FileA"};
    try {
