...
public class EchoTest {
  ...
  /**
   * These tests would test the echo parameter for several cases: no parameter, one incorrect
   * parameter(not surrounded by quotations) and more than one parameter which are all invalid
